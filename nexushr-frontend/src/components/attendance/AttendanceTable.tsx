import { getAttendanceByDate } from "@/state/attendanceSlice";
      ...
      <table className="w-full">
        <thead>
          <tr className="bg-slate-900">
            <th className="p-4 text-left text-slate-400">Employee</th>

            <th className="p-4 text-left text-slate-400">Date</th>

            <th className="p-4 text-left text-slate-400">Check In</th>

            <th className="p-4 text-left text-slate-400">Check Out</th>

            <th className="p-4 text-left text-slate-400">Hours</th>
        ...
        <tbody>
          {attendances.map((attendance) => (
            <tr key={attendance.id} className="border-t border-slate-800">
              ...
              <td className="p-4 text-slate-300">{attendance.date}</td>

              <td className="p-4 text-slate-300">{attendance.checkIn}</td>

              <td className="p-4 text-slate-300">{attendance.checkOut}</td>

              <td className="p-4 text-slate-300">{attendance.workedHours}</td>
