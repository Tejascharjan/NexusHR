...
import {
  ...
  attendanceSchema,
} from "../validation/attendanceSchema";
...
const MarkAttendanceForm = () => {
  ...
  return (
    <form
      ...
      className="bg-card-bg border border-border-primary rounded-2xl p-6 space-y-6">
      <div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <SelectField
          ...
          error={errors.biometricVerified?.message}>
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          className="px-5 py-2.5 bg-accent hover:bg-accent-hover rounded-xl text-white font-medium transition-colors">
          Mark Attendance
        </button>
      </div>
    </form>
